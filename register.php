          ...
          <div class="card-body">
            <form action="register_save.php" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-9">
                  <button type="submit" class="btn btn-primary btn-sm"><i class="bi bi-pencil pe-2"></i>สมัครสมาชิก</button>
                </div>
              </div>
